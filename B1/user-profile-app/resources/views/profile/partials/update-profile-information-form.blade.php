<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        @if(auth()->user()->avatar)
            ...
            {{-- <img src="{{ asset('storage/' . auth()->user()->avatar) }}" alt="Avatar" style="width: 150px; height: 150px; border-radius: 50%;"> --}}
        @else
        <p>No avatar set.</p>
        @endif
        </div>
        ...
        {{-- <div>
            ...
            <img src="{{ Storage::url($user->avatar) }}" alt="chưa có avatar" style="width: 150px; height: 150px; border-radius: 50%;">
